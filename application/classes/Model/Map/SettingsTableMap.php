...
class SettingsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Map.SettingsTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Settings';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Settings';
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'name' => 1, 'value' => 2, ),
        self::TYPE_COLNAME       => array(SettingsTableMap::COL_ID => 0, SettingsTableMap::COL_NAME => 1, SettingsTableMap::COL_VALUE => 2, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID' => 0, 'COL_NAME' => 1, 'COL_VALUE' => 2, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Model\\Settings');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Model\Settings) { // it's a model object

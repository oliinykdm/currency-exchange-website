...
use \Exception;
use \PDO;
use Model\Settings as ChildSettings;
...
abstract class SettingsQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Model\Base\SettingsQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'obmennik', $modelName = '\\Model\\Settings', $modelAlias = null)
    {

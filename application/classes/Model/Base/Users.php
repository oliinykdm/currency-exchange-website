...
abstract class Users implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Map\\UsersTableMap';
    ...
    /**
     * The value for the recover_key field.
     * @var        string
     */
    ...
    /**
     * Initializes internal state of Model\Base\Users object.
     * @see applyDefaults()
     */
    ...
    /**
     * Get the [registration_date] column value.
     * 
     * @return int
     */
    ...
    /**
     * Get the [recover_key] column value.
     * 
     * @return string
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UsersTableMap::translateFieldName('Role', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : UsersTableMap::translateFieldName('Wmid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->wmid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : UsersTableMap::translateFieldName('RegistrationDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->registration_date = (null !== $col) ? (int) $col : null;
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : UsersTableMap::translateFieldName('RecoverKey', TableMap::TYPE_PHPNAME, $indexType)];
            $this->recover_key = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\Users'), 0, $e);
        }
    }
     ...
     * @return $this|\Model\Users The current object (for fluent API support)
     */
    ...
    /**
     * Set the value of [wmid] column.
     * 
     * @param  string $v new value
     * @return $this|\Model\Users The current object (for fluent API support)
     */
    public function setWmid($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->wmid !== $v) {
            $this->wmid = $v;
            $this->modifiedColumns[UsersTableMap::COL_WMID] = true;
        }
    ...
    /**
     * Set the value of [registration_date] column.
     * 
     * @param  int $v new value
     * @return $this|\Model\Users The current object (for fluent API support)
     */
    public function setRegistrationDate($v)
    {
        ...
        if ($this->registration_date !== $v) {
            ...
            $this->modifiedColumns[UsersTableMap::COL_REGISTRATION_DATE] = true;
        }
    ...
    /**
     * Set the value of [recover_key] column.
     * 
     * @param  string $v new value
     * @return $this|\Model\Users The current object (for fluent API support)
     */
    public function setRecoverKey($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->recover_key !== $v) {
            $this->recover_key = $v;
            $this->modifiedColumns[UsersTableMap::COL_RECOVER_KEY] = true;
        }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_WMID)) {
            $modifiedColumns[':p' . $index++]  = '`WMID`';
        }
        if ($this->isColumnModified(UsersTableMap::COL_REGISTRATION_DATE)) {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_RECOVER_KEY)) {
            $modifiedColumns[':p' . $index++]  = '`RECOVER_KEY`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`PASSWORD`':                        
                        ...
                        break;
                    case '`WMID`':                        
                        $stmt->bindValue($identifier, $this->wmid, PDO::PARAM_STR);
                        break;
                    case '`REGISTRATION_DATE`':                        
                        $stmt->bindValue($identifier, $this->registration_date, PDO::PARAM_INT);
                        break;
                    case '`PHONE`':                        
                    ...
                    case '`BIRTHDAY`':                        
                        ...
                        break;
                    case '`RECOVER_KEY`':                        
                        $stmt->bindValue($identifier, $this->recover_key, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
     ...
     *
     * @return $this|\Model\Users The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_WMID)) {
            $criteria->add(UsersTableMap::COL_WMID, $this->wmid);
        }
        if ($this->isColumnModified(UsersTableMap::COL_REGISTRATION_DATE)) {
            $criteria->add(UsersTableMap::COL_REGISTRATION_DATE, $this->registration_date);
        }
        if ($this->isColumnModified(UsersTableMap::COL_PHONE)) {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_RECOVER_KEY)) {
            $criteria->add(UsersTableMap::COL_RECOVER_KEY, $this->recover_key);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\Users (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Users Clone of current object.
     * @throws PropelException
     */

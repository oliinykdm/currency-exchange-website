...
abstract class ExchangesPrepare implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Map\\ExchangesPrepareTableMap';
    ...
    /**
     * Initializes internal state of Model\Base\ExchangesPrepare object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>ExchangesPrepare</code> instance.  If
     * <code>obj</code> is an instance of <code>ExchangesPrepare</code>, delegates to
     * <code>equals(ExchangesPrepare)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ExchangesPrepare The current object, for fluid interface
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ExchangesPrepareTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ExchangesPrepareTableMap::translateFieldName('Userid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->userid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ExchangesPrepareTableMap::translateFieldName('Surname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->surname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ExchangesPrepareTableMap::translateFieldName('Firstname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->firstname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ExchangesPrepareTableMap::translateFieldName('Patronymic', TableMap::TYPE_PHPNAME, $indexType)];
            $this->patronymic = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ExchangesPrepareTableMap::translateFieldName('Email', TableMap::TYPE_PHPNAME, $indexType)];
            $this->email = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ExchangesPrepareTableMap::translateFieldName('Phone', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phone = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : ExchangesPrepareTableMap::translateFieldName('PaymentDetailsFrom', TableMap::TYPE_PHPNAME, $indexType)];
            $this->payment_details_from = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : ExchangesPrepareTableMap::translateFieldName('PaymentDetailsTo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->payment_details_to = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : ExchangesPrepareTableMap::translateFieldName('ChangeFromCurr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->change_from_curr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : ExchangesPrepareTableMap::translateFieldName('ChangeToCurr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->change_to_curr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : ExchangesPrepareTableMap::translateFieldName('ChangeFromAmount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->change_from_amount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : ExchangesPrepareTableMap::translateFieldName('ChangeToAmount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->change_to_amount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : ExchangesPrepareTableMap::translateFieldName('ExchangeDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->exchange_date = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : ExchangesPrepareTableMap::translateFieldName('ExchangeUniqid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->exchange_uniqid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : ExchangesPrepareTableMap::translateFieldName('ExchangeStatus', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 16; // 16 = ExchangesPrepareTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\ExchangesPrepare'), 0, $e);
        }
    }
     ...
     * @return $this|\Model\ExchangesPrepare The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ExchangesPrepareTableMap::COL_ID] = true;
        }
    ...
    public function setUserid($v)
    {
        ...
        if ($this->userid !== $v) {
            $this->userid = $v;
            $this->modifiedColumns[ExchangesPrepareTableMap::COL_USERID] = true;
        }
    ...
    public function setSurname($v)
    {
        ...
        if ($this->surname !== $v) {
            $this->surname = $v;
            $this->modifiedColumns[ExchangesPrepareTableMap::COL_SURNAME] = true;
        }
    ...
    public function setFirstname($v)
    {
        ...
        if ($this->firstname !== $v) {
            $this->firstname = $v;
            $this->modifiedColumns[ExchangesPrepareTableMap::COL_FIRSTNAME] = true;
        }
    ...
    public function setPatronymic($v)
    {
        ...
        if ($this->patronymic !== $v) {
            $this->patronymic = $v;
            $this->modifiedColumns[ExchangesPrepareTableMap::COL_PATRONYMIC] = true;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[ExchangesPrepareTableMap::COL_EMAIL] = true;
        }
    ...
    public function setPhone($v)
    {
        ...
        if ($this->phone !== $v) {
            $this->phone = $v;
            $this->modifiedColumns[ExchangesPrepareTableMap::COL_PHONE] = true;
        }
    ...
    public function setPaymentDetailsFrom($v)
    {
        ...
        if ($this->payment_details_from !== $v) {
            ...
            $this->modifiedColumns[ExchangesPrepareTableMap::COL_PAYMENT_DETAILS_FROM] = true;
        }
    ...
    public function setPaymentDetailsTo($v)
    {
        ...
        if ($this->payment_details_to !== $v) {
            ...
            $this->modifiedColumns[ExchangesPrepareTableMap::COL_PAYMENT_DETAILS_TO] = true;
        }
    ...
    public function setChangeFromCurr($v)
    {
        ...
        if ($this->change_from_curr !== $v) {
            ...
            $this->modifiedColumns[ExchangesPrepareTableMap::COL_CHANGE_FROM_CURR] = true;
        }
    ...
    public function setChangeToCurr($v)
    {
        ...
        if ($this->change_to_curr !== $v) {
            ...
            $this->modifiedColumns[ExchangesPrepareTableMap::COL_CHANGE_TO_CURR] = true;
        }
    ...
    public function setChangeFromAmount($v)
    {
        ...
        if ($this->change_from_amount !== $v) {
            ...
            $this->modifiedColumns[ExchangesPrepareTableMap::COL_CHANGE_FROM_AMOUNT] = true;
        }
    ...
    public function setChangeToAmount($v)
    {
        ...
        if ($this->change_to_amount !== $v) {
            ...
            $this->modifiedColumns[ExchangesPrepareTableMap::COL_CHANGE_TO_AMOUNT] = true;
        }
    ...
    public function setExchangeDate($v)
    {
        ...
        if ($this->exchange_date !== $v) {
            ...
            $this->modifiedColumns[ExchangesPrepareTableMap::COL_EXCHANGE_DATE] = true;
        }
    ...
    public function setExchangeUniqid($v)
    {
        ...
        if ($this->exchange_uniqid !== $v) {
            ...
            $this->modifiedColumns[ExchangesPrepareTableMap::COL_EXCHANGE_UNIQID] = true;
        }
    ...
    public function setExchangeStatus($v)
    {
        ...
        if ($this->exchange_status !== $v) {
            ...
            $this->modifiedColumns[ExchangesPrepareTableMap::COL_EXCHANGE_STATUS] = true;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildExchangesPrepareQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ExchangesPrepare::setDeleted()
     * @see ExchangesPrepare::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildExchangesPrepareQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ExchangesPrepareTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_USERID)) {
            $modifiedColumns[':p' . $index++]  = '`USERID`';
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_SURNAME)) {
            $modifiedColumns[':p' . $index++]  = '`SURNAME`';
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_FIRSTNAME)) {
            $modifiedColumns[':p' . $index++]  = '`FIRSTNAME`';
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_PATRONYMIC)) {
            $modifiedColumns[':p' . $index++]  = '`PATRONYMIC`';
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = '`EMAIL`';
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_PHONE)) {
            $modifiedColumns[':p' . $index++]  = '`PHONE`';
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_PAYMENT_DETAILS_FROM)) {
            $modifiedColumns[':p' . $index++]  = '`PAYMENT_DETAILS_FROM`';
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_PAYMENT_DETAILS_TO)) {
            $modifiedColumns[':p' . $index++]  = '`PAYMENT_DETAILS_TO`';
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_CHANGE_FROM_CURR)) {
            $modifiedColumns[':p' . $index++]  = '`CHANGE_FROM_CURR`';
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_CHANGE_TO_CURR)) {
            $modifiedColumns[':p' . $index++]  = '`CHANGE_TO_CURR`';
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_CHANGE_FROM_AMOUNT)) {
            $modifiedColumns[':p' . $index++]  = '`CHANGE_FROM_AMOUNT`';
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_CHANGE_TO_AMOUNT)) {
            $modifiedColumns[':p' . $index++]  = '`CHANGE_TO_AMOUNT`';
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_EXCHANGE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '`EXCHANGE_DATE`';
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_EXCHANGE_UNIQID)) {
            $modifiedColumns[':p' . $index++]  = '`EXCHANGE_UNIQID`';
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_EXCHANGE_STATUS)) {
            $modifiedColumns[':p' . $index++]  = '`EXCHANGE_STATUS`';
        }

        $sql = sprintf(
            'INSERT INTO `exchanges_prepare` (%s) VALUES (%s)',
    ...
    {
        $pos = ExchangesPrepareTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ExchangesPrepare'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ExchangesPrepare'][$this->getPrimaryKey()] = true;
        $keys = ExchangesPrepareTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Model\ExchangesPrepare
     */
     ...
     *
     * @return $this|\Model\ExchangesPrepare The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_ID)) {
            $criteria->add(ExchangesPrepareTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_USERID)) {
            $criteria->add(ExchangesPrepareTableMap::COL_USERID, $this->userid);
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_SURNAME)) {
            $criteria->add(ExchangesPrepareTableMap::COL_SURNAME, $this->surname);
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_FIRSTNAME)) {
            $criteria->add(ExchangesPrepareTableMap::COL_FIRSTNAME, $this->firstname);
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_PATRONYMIC)) {
            $criteria->add(ExchangesPrepareTableMap::COL_PATRONYMIC, $this->patronymic);
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_EMAIL)) {
            $criteria->add(ExchangesPrepareTableMap::COL_EMAIL, $this->email);
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_PHONE)) {
            $criteria->add(ExchangesPrepareTableMap::COL_PHONE, $this->phone);
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_PAYMENT_DETAILS_FROM)) {
            $criteria->add(ExchangesPrepareTableMap::COL_PAYMENT_DETAILS_FROM, $this->payment_details_from);
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_PAYMENT_DETAILS_TO)) {
            $criteria->add(ExchangesPrepareTableMap::COL_PAYMENT_DETAILS_TO, $this->payment_details_to);
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_CHANGE_FROM_CURR)) {
            $criteria->add(ExchangesPrepareTableMap::COL_CHANGE_FROM_CURR, $this->change_from_curr);
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_CHANGE_TO_CURR)) {
            $criteria->add(ExchangesPrepareTableMap::COL_CHANGE_TO_CURR, $this->change_to_curr);
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_CHANGE_FROM_AMOUNT)) {
            $criteria->add(ExchangesPrepareTableMap::COL_CHANGE_FROM_AMOUNT, $this->change_from_amount);
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_CHANGE_TO_AMOUNT)) {
            $criteria->add(ExchangesPrepareTableMap::COL_CHANGE_TO_AMOUNT, $this->change_to_amount);
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_EXCHANGE_DATE)) {
            $criteria->add(ExchangesPrepareTableMap::COL_EXCHANGE_DATE, $this->exchange_date);
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_EXCHANGE_UNIQID)) {
            $criteria->add(ExchangesPrepareTableMap::COL_EXCHANGE_UNIQID, $this->exchange_uniqid);
        }
        if ($this->isColumnModified(ExchangesPrepareTableMap::COL_EXCHANGE_STATUS)) {
            $criteria->add(ExchangesPrepareTableMap::COL_EXCHANGE_STATUS, $this->exchange_status);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\ExchangesPrepare (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\ExchangesPrepare Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(ExchangesPrepareTableMap::DEFAULT_STRING_FORMAT);
    }
